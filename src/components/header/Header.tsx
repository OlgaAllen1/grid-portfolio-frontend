...
import "./Header.css";
import { BiCopy, BiLogoLinkedinSquare, BiCheck, BiDownload } from "react-icons/bi";
import noAvatar from "../../assets/user.png";
import { IMainData } from "../../types";

const Header = forwardRef(
    (
        { avatar, email, description, linkedIn, name, position }: IMainData,
        ...
        return (
            <header className="block header section" ref={ref}>
                <h2>{position}</h2>
                <h1>{name}</h1>
                <p>{description}</p>
